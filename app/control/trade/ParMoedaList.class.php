...
class ParMoedaList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('ParMoeda');   // defines the active record
        parent::setDefaultOrder('id', 'asc');         // defines the default order
        parent::addFilterField('id', '=', 'id'); // filterField, operator, formField
        parent::addFilterField('descricao', 'like', 'descricao'); // filterField, operator, formField
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_ParMoeda');
        ...
        $this->form->addAction(_t('New'),  new TAction(array('ParMoedaForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('ParMoedaForm', 'onEdit'));
